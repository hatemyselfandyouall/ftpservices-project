...
<script type="text/javascript">
	function autoSubmit(){
		...
		$.post("/test/getProjectList",{
			"projectName":projectName,
			"projectType":projectType
		},function(data){
			var valueList = JSON.stringify(data.result);
			var reportURL = FR.cjkEncode("../ReportServer?reportlet=ProjectTaskBookAjax.cpt&valueList="+valueList);
