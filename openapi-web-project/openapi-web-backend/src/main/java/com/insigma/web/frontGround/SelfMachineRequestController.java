...
//        openapiSelfmachineRequestSaveVO.setAppKey("123");
        openapiSelfmachineRequestSaveVO.setCertificate("ba1a13d019e7cd98d2e2876e6697eb32");
...
//        String token="d942365d82cfdb999834199a3ca0f7";
        responseEntity=restTemplate.postForEntity("http://openapibk.insigma.com:6011/api/selfMachineRequest/testToken?token="+token,
                null,String.class);
        System.out.println(responseEntity.getBody());
    }
}
