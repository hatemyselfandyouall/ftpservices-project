...
public class RoundRobinLoadBalance extends AbstractLoadBalance {
    ...
    public OpenapiInterfaceInnerUrl doSelect(final List<OpenapiInterfaceInnerUrl> upstreamList, final String ip) {
        String key = upstreamList.get(0).getInnerUrl();
        ...
        OpenapiInterfaceInnerUrl selectedInvoker = null;
        WeightedRoundRobin selectedWRR = null;
        for (OpenapiInterfaceInnerUrl upstream : upstreamList) {
            String rKey = upstream.getInnerUrl();
