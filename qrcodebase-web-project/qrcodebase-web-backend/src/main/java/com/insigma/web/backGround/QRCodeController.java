...
import com.insigma.enums.QrcodebaseCacheEnum;
...
public class QRCodeController {
    ...
    private static final Integer NEED_CACHE=1;
    @Autowired
    ...
    public String textToIMG(@RequestBody CreateIMGVO createIMGVO,HttpServletResponse response){
...
//        return resultVo;
    ...
    //todo 有与无缓存接口提供，10分钟缓存，文档书写，缓存暂时不做
    ...
    public String textToBarCode(@RequestBody CreateBarCodeVO createBarCodeVO, HttpServletResponse response){
//        ResultVo resultVo=new ResultVo();
        try(OutputStream os=response.getOutputStream()){
